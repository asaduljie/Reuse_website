...
if (redirectPath) {
  ...
  router.replace(getRoleBasedRedirectPath(normalizedUser.role));
}
      } else {
      ...
      <div className="w-full lg:w-[45%] xl:w-[40%] flex flex-col justify-center items-center px-6 py-12 md:px-12 relative z-10">
        ...
        <div className="relative bg-white/90 backdrop-blur-md border border-gray-100/80 rounded-[32px] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.02)] w-full max-w-md transition-all duration-300">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-xs font-bold text-gray-400 mt-1.5 uppercase tracking-widest">Akses ReUse Marketplace</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="bg-slate-50 border border-slate-100 text-slate-800 placeholder-slate-400 p-4 rounded-2xl w-full focus:outline-none focus:border-emerald-500 focus:bg-white transition-all duration-300 font-semibold"
                required
              />
            </div>
