...
export default function ChibiFarmerLoader() {
  return (
    <div className="flex flex-col items-center justify-center select-none">
      {/* SVG Chibi Farmer (Transparent background for beautiful blur integration) */}
      <div className="relative w-36 h-36 drop-shadow-lg">
        ...
        >
          ...
          {/* Background Sky / Soft Green Glow */}
          ...
          <circle cx="36.5" cy="56.2" r="0.8" fill="#FFFFFF" />
          
          <circle cx="49" cy="57" r="2.2" fill="#1F2937" />
          <circle cx="48.5" cy="56.2" r="0.8" fill="#FFFFFF" />
